"""Measure input-bit-position avalanche bias for mini-sha bit255."""
...
OUT_DIR = Path("results/2026-05-12-avalanche-mini-sha-13-bit255-input-bits")
ROUNDS = 13
INPUT_BYTES = 32
OUTPUT_BYTES = 32
...
def measure() -> tuple[list[dict[str, object]], list[dict[str, object]], list[dict[str, object]]]:
    ...
    return seed_rows, pooled_by_input, summary_rows
...
def main() -> None:
    ...
    config = {
        "experiment": "avalanche-mini-sha-13-bit255-input-bits",
        "issue": 44,
        ...
        "ci_method": "wilson_score",
        "ci_level": 0.95,
        "multiple_comparison": "Holm over 256 input bit positions",
        "alpha": ALPHA,
